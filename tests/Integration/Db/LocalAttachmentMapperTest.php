...
class LocalAttachmentMapperTest extends TestCase {
	...
	protected function setUp(): void {
		...
		$attachment = LocalAttachment::fromParams([
			...
			'mimeType' => 'image/jpeg',
			'userId' => $this->getTestAccountUserId(),
	...
	public function testFind(): void {
		$this->mapper->saveLocalMessageAttachments($this->localMessageIds[0], $this->attachmentIds);
		$foundAttachment = $this->mapper->find($this->getTestAccountUserId(), $this->attachmentIds[0]);
		...
		$this->assertEquals($this->getTestAccountUserId(), $foundAttachment->getUserId());

		$this->expectException(DoesNotExistException::class);
		$this->mapper->find($this->getTestAccountUserId(), $this->attachmentIds[1]);
	}
